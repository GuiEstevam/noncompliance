...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            ...
            ['name' => 'Caê Teixeira', 'username' => 'cae.teixeira', 'password' => Hash::make('C0nsult@'), 'departament' => '4', 'created_at' => $now, 'updated_at' => $now, 'role_id' => '1'],
            ['name' => 'Kaique Manfredi', 'username' => 'kaique.manfredi', 'password' => Hash::make('C0nsult@'), 'departament' => '4', 'created_at' => $now, 'updated_at' => $now, 'role_id' => '1'],
            ['name' => 'Leticia Oliveira', 'username' => 'leticia.oliveira', 'password' => Hash::make('C0nsult@'), 'departament' => '4', 'created_at' => $now, 'updated_at' => $now, 'role_id' => '1'],
            ...
            ['name' => 'Camila Oliveira', 'username' => 'camila.oliveira', 'password' => Hash::make('C0nsult@'), 'departament' => '3', 'created_at' => $now, 'updated_at' => $now, 'role_id' => '1'],
            ['name' => 'Karina Aguiar', 'username' => 'karina.aguiar', 'password' => Hash::make('C0nsult@'), 'departament' => '3', 'created_at' => $now, 'updated_at' => $now, 'role_id' => '3'],
            ...
            ['name' => 'Lívia Freitas', 'username' => 'livia.freitas', 'password' => Hash::make('C0nsult@'), 'departament' => '3', 'created_at' => $now, 'updated_at' => $now, 'role_id' => '1'],
            ['name' => 'Sueli Cordeiro', 'username' => 'sueli.cordeiro', 'password' => Hash::make('C0nsult@'), 'departament' => '3', 'created_at' => $now, 'updated_at' => $now, 'role_id' => '1'],
            ['name' => 'Nayane Silva', 'username' => 'nayane.silva', 'password' => Hash::make('C0nsult@'), 'departament' => '3', 'created_at' => $now, 'updated_at' => $now, 'role_id' => '1'],
            ['name' => 'Paloma Rodrigues', 'username' => 'paloma.rodrigues', 'password' => Hash::make('C0nsult@'), 'departament' => '3', 'created_at' => $now, 'updated_at' => $now, 'role_id' => '2'],
            ...
            ['name' => 'Mônica Souza', 'username' => 'monica.souza', 'password' => Hash::make('C0nsult@'), 'departament' => '7', 'created_at' => $now, 'updated_at' => $now, 'role_id' => '2'],
