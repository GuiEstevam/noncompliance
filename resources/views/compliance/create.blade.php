...
<div class="formbold-main-wrapper">
    <div class="formbold-form-wrapper">
        ...
        <form action="functions/salvar.php" method="POST">
            ...
            <div>
                ...
                <textarea rows="6" name="non_compliance" id="non_compliance" placeholder="Descreva aqui a não conformidade" class="formbold-form-input" required></textarea>
            </div>
            ...
            <div>
                ...
                <textarea rows="6" name="instant_action" id="instant_action" placeholder="Descreva aqui a ação imediata" class="formbold-form-input" required></textarea>
            </div>
